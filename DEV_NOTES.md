...
| Login                       | Integrated into *Landing Page*                          |
...
### eventAnsehen
- Teilnehmerliste |Teilnehmer (email)| Eingeladen | Ausschlüsse (anzahl)|
- Teilnehmer bearbeiten - EventID entfernen, Teilnehmeremail + Ausschlussliste + Entfernen Button -> 4-5 Zeilen gleichzeitig