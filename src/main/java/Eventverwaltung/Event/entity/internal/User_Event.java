...
@NamedQuery(name = "User_Event.groessteSubgruppe", query = "select count(ue.subgruppe) from User_Event ue where ue.event = :event group by ue.subgruppe")
public class User_Event implements Serializable {
    ...
    public static final String GET_GROESSESUBGRUPPE = "User_Event.groessteSubgruppe";
    public User_Event() {
    }
